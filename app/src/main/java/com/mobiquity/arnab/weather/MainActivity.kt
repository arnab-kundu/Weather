...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.appBarMain.fab.requestFocus()
        binding.appBarMain.fab.setOnClickListener { view ->
            //Snackbar.make(view, "Add location to your favorite list using Map", Snackbar.LENGTH_LONG).setAction("Action", null).show()
        ...
        appBarConfiguration = AppBarConfiguration(
            setOf(
                R.id.nav_home, R.id.nav_settings, R.id.nav_help, R.id.nav_city
            ), drawerLayout
        )
